...
Las bases de datos **No‑SQL** (Not Only SQL) surgen para dar respuesta a las limitaciones de las bases de datos relacionales tradicionales en escenarios con grandes volúmenes de datos, alta concurrencia y sistemas distribuidos.
...
- **Datos semi-estructurados** (XML, JSON, etc)
...
- Permitir trabajar con **datos heterogéneos** (cada registro puede tener campos diferentes)
...
- Uso en sistemas de *Business Intelligence* (Power By)
